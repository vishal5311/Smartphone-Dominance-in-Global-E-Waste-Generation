...
import numpy as np
import os
os.system("pip install matplotlib plotly")
...
with st.spinner("Loading E-Waste Prediction Model..."):
    ...
    try:
        model = pickle.load(open("C:\\Users\\visha\\ewaste_model.pkl", 'rb'))
        ...
        st.warning("Using a demo mode with simulated predictions.")
        model = None
